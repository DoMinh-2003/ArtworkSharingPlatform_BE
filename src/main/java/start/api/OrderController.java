...
public class OrderController {
    @GetMapping("/order")
    public ResponseEntity createUrl(@RequestParam String orderId) throws NoSuchAlgorithmException, InvalidKeyException, Exception {
        ...
        String returnUrl = "http://mycremo.art/checkout?";
